...
class Auctions_For_Woocommerce_Widget_Watchlist_Auction extends WC_Widget {

	/**
	 * Constructor.
	 */
	public function __construct() {
		$this->widget_cssclass    = 'woocommerce widget_watchlist_auctions';
		$this->widget_description = esc_html__( 'Display a list of auctions on users watchlist.', 'auctions-for-woocommerce' );
		$this->widget_id          = 'widget_watchlist_auctions';
		$this->widget_name        = esc_html__( 'WooCommerce My Watchlist', 'auctions-for-woocommerce' );
		$this->settings           = array(
			'title'     => array(
				'type'  => 'text',
				'std'   => __( 'My Watchlist', 'auctions-for-woocommerce' ),
