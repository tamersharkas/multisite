 ...
 *
 * @class WC_Email_Auction_Relist_User
 * @extends WC_Email
 */

class WC_Email_Auction_Relist_User extends WC_Email {
	/**
	 * Winning bid
	 * 
	 * @var float
	...
	public function __construct() {
		...
		$this->title          = __( 'Auction relist user notice', 'auctions-for-woocommerce' );
		$this->description    = __( 'Auction relist user emails are sent to wining user when auction is relisted.', 'auctions-for-woocommerce' );
		...
		$this->heading        = __( 'Auction Relist Notification', 'auctions-for-woocommerce' );
